...
const CartPage = ({ singleRes , togglePopUpDelete }) => {
            ...
            {totalPrice === 0 ? <p>سبد خرید شما خالی است</p> :
                ...
                <div style={{ padding: '14px 10px', backgroundColor: 'white', borderRadius: '0.5rem', border: "1px solid rgba(58, 61, 66, 0.06)" }}>
                    ...
                    <div style={{ marginTop: 50 }}>
                        <button style={{ width: '100%', height: '40px', fontSize: 17, backgroundColor: 'rgb(255, 0, 166)', border: '0.09375rem solid rgb(255, 0, 166)', borderRadius: '0.375rem', color: 'white' }}>ثبت سفارش</button>
                    </div>
                </div>
